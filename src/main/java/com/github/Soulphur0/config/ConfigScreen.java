...
public class ConfigScreen {
    ...
    ConfigBuilder builder = ConfigBuilder.create().setParentScreen(screen).setTitle(Component.translatable("Elytra Aeronautics Configuration Screen"));
    ConfigEntryBuilder entryBuilder = builder.entryBuilder();

    // Config categories
    ConfigCategory elytraFlightSettings = builder.getOrCreateCategory(Component.translatable("Elytra flight settings"));
    ConfigCategory cloudSettings = builder.getOrCreateCategory(Component.translatable("Cloud settings"));
    ...
    private void buildElytraFlightCategory() {
        elytraFlightSettings.addEntry(entryBuilder.startBooleanToggle(Component.translatable("Altitude determines flight speed"), eanConfigFile.isAltitudeDeterminesSpeed())
                .setDefaultValue(true)
                .setTooltip(Component.translatable("Set to true if you want to elytra flight be faster at higher altitudes. If set to false, your flight speed will be determined by the minimal speed."))
                .setSaveConsumer(eanConfigFile::setAltitudeDeterminesSpeed)
                .build());

        elytraFlightSettings.addEntry(entryBuilder.startDoubleField(Component.translatable("Minimal flight speed (m/s)"), eanConfigFile.getMinSpeed())
                .setDefaultValue(30.35D)
                .setTooltip(Component.translatable("Minimal flight speed achieved by travelling at a zero degree angle. (The default value is the vanilla value.)"))
                .setSaveConsumer(newValue -> eanConfigFile.setMinSpeed(newValue))
                .build());

        elytraFlightSettings.addEntry(entryBuilder.startDoubleField(Component.translatable("Maximum flight speed (m/s)"), eanConfigFile.getMaxSpeed())
                .setDefaultValue(257.22D)
                .setTooltip(Component.translatable("Maximum flight speed achieved by travelling at a zero degree angle."))
                .setSaveConsumer(newValue -> eanConfigFile.setMaxSpeed(newValue))
                .build());

        elytraFlightSettings.addEntry(entryBuilder.startDoubleField(Component.translatable("Flight speed curve beginning"), eanConfigFile.getCurveStart())
                .setDefaultValue(250.0D)
                .setTooltip(Component.translatable("Altitude at which flight speed start to increase."))
                .setSaveConsumer(newValue -> eanConfigFile.setCurveStart(newValue))
                .build());

        elytraFlightSettings.addEntry(entryBuilder.startDoubleField(Component.translatable("Flight speed curve end"), eanConfigFile.getCurveEnd())
                .setDefaultValue(1000.0D)
                .setTooltip(Component.translatable("Altitude at which flight speed stops to increase (maximum flight speed is achieved)."))
                .setSaveConsumer(newValue -> eanConfigFile.setCurveEnd(newValue))
                .build());

        elytraFlightSettings.addEntry(entryBuilder.startBooleanToggle(Component.translatable("Sneaking realigns pitch."), eanConfigFile.isSneakRealignsPitch())
                .setDefaultValue(true)
                .setTooltip(Component.translatable("When true, sneaking mid-flight will realign your pitch."))
                .setSaveConsumer(newValue -> eanConfigFile.setSneakRealignsPitch(newValue))
                .build());

        elytraFlightSettings.addEntry(entryBuilder.startFloatField(Component.translatable("Pitch realignment angle."), eanConfigFile.getRealignmentAngle())
                .setDefaultValue(0)
                .setTooltip(Component.translatable("Pitch angle at which the player will align when sneaking mid-flight."))
                .setSaveConsumer(newValue -> eanConfigFile.setRealignmentAngle(newValue))
                .build());

        elytraFlightSettings.addEntry(entryBuilder.startFloatField(Component.translatable("Pitch realignment rate."), eanConfigFile.getRealignmentRate())
                .setDefaultValue(0.1F)
                .setTooltip(Component.translatable("Amount of rotation (angle-per-tick), at which the player will be rotating towards the pitch realignment angle when sneaking mid-air."))
    ...
    private void buildCloudCategory(EanConfigFile eanConfigFile) {
        ...
        // ? General settings
        cloudSettings.addEntry(entryBuilder.startBooleanToggle(Component.translatable("Reset to the default preset?"), false)
                .setDefaultValue(true).setTooltip(Component.translatable("Set this to \"yes\" and save to reset cloud layers to the default preset. All previous cloud layers will be removed and 2 new layers will be placed at the flight-speed-curve's middle and highest points."))
        ...
        cloudSettings.addEntry(entryBuilder.startTextDescription(Component.translatable("--- General settings ---"))
                .setTooltip(Component.translatable("Settings applied to all cloud layers at once!"))
                .build());

        // Layer amount field.
        cloudSettings.addEntry(entryBuilder.startIntField(Component.translatable("Cloud layer amount"), eanConfigFile.getLayerAmount())
                .setTooltip(Component.translatable("This value determines the amount of cloud layers there are. Besides the vanilla clouds. To make new layers show up in the config, re-enter the menu without restarting. For changes to apply in-game however, restarting is necessary."))
                .setDefaultValue(2)
                .setMin(0)
                .setSaveConsumer(newValue -> {
        ...
        cloudSettings.addEntry(entryBuilder.startFloatField(Component.translatable("Distance between cloud layers"), eanConfigFile.getLayerDistance())
                .setTooltip(Component.translatable("When this value is changed, all cloud layers are relocated, and, starting from the altitude specified in the field below; they are placed on top of each other separated by this distance."))
        ...
        cloudSettings.addEntry(entryBuilder.startFloatField(Component.translatable("Cloud layers' lowest altitude"), eanConfigFile.getStackingAltitude())
                .setTooltip(Component.translatable("When the distance between clouds is modified, clouds will re-stacked on top of each other starting at the altitude specified in this field."))
        ...
        cloudSettings.addEntry(entryBuilder
                .startDropdownMenu(
                        Component.translatable("Cloud type"),
                        ...
                        DropdownMenuBuilder.CellCreatorBuilder.of(value ->
                        {
                            if (CloudTypes.LOD.equals(value)) {
                                return Component.translatable("LOD");
                            } else if (CloudTypes.FAST.equals(value)) {
                                return Component.translatable("FAST");
                            } else if (CloudTypes.FANCY.equals(value)) {
                                return Component.translatable("FANCY");
                            }
                            return Component.translatable("UNKNOWN CLOUD TYPE");
                        }))
        ...
        cloudSettings.addEntry(entryBuilder
                .startDropdownMenu(
                        Component.translatable("Render mode"),
                        ...
                        DropdownMenuBuilder.CellCreatorBuilder.of(value ->
                        {
                            if (CloudRenderModes.NEVER_RENDER.equals(value)) {
                                return Component.translatable("NEVER_RENDER");
                            } else if (CloudRenderModes.TWO_IN_ADVANCE.equals(value)) {
                                return Component.translatable("TWO_IN_ADVANCE");
                            } else if (CloudRenderModes.ONE_IN_ADVANCE.equals(value)) {
                                return Component.translatable("ONE_IN_ADVANCE");
                            } else if (CloudRenderModes.ALWAYS_RENDER.equals(value)) {
                                return Component.translatable("ALWAYS_RENDER");
                            }
                            return Component.translatable("");
                        }))
                .setDefaultValue(CloudRenderModes.ALWAYS_RENDER)
                .setTooltip(Component.translatable("This value determines when a cloud layer begins to render."))
                .setSuggestionMode(false)
        ...
        cloudSettings.addEntry(entryBuilder
                .startDropdownMenu(
                        Component.translatable("LOD render mode"),
                ...
                .setTooltip(Component.translatable("This value determines when a cloud layer begins to render in high level of detail. It is only used if the cloud type is set to LOD."))
                .setSuggestionMode(false)
                .setSelections(Arrays.asList(CloudRenderModes.values()))
                .setSaveConsumer(newValue -> {
        ...
        // Use smooth LODs
        cloudSettings.addEntry(entryBuilder
                .startBooleanToggle(Component.translatable("Smooth LODs"), eanConfigFile.isUseSmoothLODs())
                .setTooltip(Component.translatable("Gradually puffs up LOD clouds as the player approaches them so the LOD transition is not too rough. This option may use up more resources. Clouds begin to puff up at half distance from their layer."))
        ...
        for (CloudLayer layer : cloudLayerList) {
            ...
            layerAttributesList.get(layerNum).add(entryBuilder
                    .startFloatField(Component.translatable("Altitude"), layer.getAltitude())
            ...
            layerAttributesList.get(layerNum).add(entryBuilder
                    .startDropdownMenu(
                            ...
                            DropdownMenuBuilder.CellCreatorBuilder.of(value ->
                            {
                                if (CloudRenderModes.NEVER_RENDER.equals(value)) {
                                    ...
                                    return Component.translatable("CUSTOM_ALTITUDE");
                                } else if (CloudRenderModes.ALWAYS_RENDER.equals(value)) {
                                    return Component.translatable("ALWAYS_RENDER");
                                }
                                return Component.translatable("NEVER_RENDER");
                    ...
                    .setDefaultValue(CloudRenderModes.ALWAYS_RENDER)
                    .setTooltip(Component.translatable("This value determines when the cloud layer begins to render. It can be one/two layers in advance, at a set altitude or always render."))
                    .setSuggestionMode(false)
                    .setSelections(Arrays.asList(CloudRenderModes.values()))
            ...
            // Render distance
            layerAttributesList.get(layerNum).add(entryBuilder
                    .startFloatField(Component.translatable("Custom render altitude"), layer.getCloudRenderDistance())
                    .setTooltip(Component.translatable("This value is only used if \"Custom altitude\" was selected as the render mode."))
            ...
            layerAttributesList.get(layerNum).add(entryBuilder
                    ...
                    .setDefaultValue(CloudRenderModes.TWO_IN_ADVANCE)
                    .setTooltip(Component.translatable("This value determines when the cloud layer begins to render in high level of detail. It is only used if the cloud type is set to LOD."))
                    .setSuggestionMode(false)
                    .setSelections(Arrays.asList(CloudRenderModes.values()))
            ...
            // LOD render distance
            layerAttributesList.get(layerNum).add(entryBuilder
                    .startFloatField(Component.translatable("Custom LOD render altitude"), layer.getLodRenderDistance())
                    .setTooltip(Component.translatable("This value is only used if \"Custom altitude\" was selected as the LOD render mode."))
                    .setDefaultValue(0.0F)
            ...
            // Use smooth LODs
            layerAttributesList.get(layerNum).add(entryBuilder
                    .startBooleanToggle(Component.translatable("Smooth LODs"), layer.isUseSmoothLODs())
                    .setTooltip(Component.translatable("Gradually puffs up LOD clouds as the player approaches them so the LOD transition is not too rough. This option may use up more resources. Clouds begin to puff up at half distance from their layer."))
                    .setDefaultValue(false)
        ...
        for (int i = 0; i < layerAttributesList.size(); i++) {
            layerList.add(i, entryBuilder.startSubCategory(Component.translatable(cloudLayerList.get(i).getName()), layerAttributesList.get(i)).build());
        }

        // * Add all layer subCategories to the main config subCategory.
        cloudSettings.addEntry(entryBuilder.startTextDescription(Component.translatable("--- Cloud layer individual configuration ---"))
                .setTooltip(Component.translatable("If you want to set up each cloud layer individually and in most detail, here is the place!"))
                .build());

        cloudSettings.addEntry(entryBuilder.startSubCategory(Component.translatable("Select a cloud layer:"), layerList)
                .build());
    }
